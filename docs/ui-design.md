...
- C08-A 分析页与开发者 Key 页从受控注册表读取已开放的 OpenAI/DeepSeek 标签；免费套餐的系统AI选择只显示 DeepSeek。C08-B 面向 Developer/Admin 的十家主流 Provider Preset 逐项验证后开放页面选择；当前百炼/OpenRouter 及其余新增预设均不显示未验证选项，自定义端点输入属于 C08-D。
